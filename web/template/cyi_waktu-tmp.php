...
<head>
    ...
    <title>Waktu - <?= $cyi["nama_app"] ?></title>
...
<body data-col="2-columns" class=" 2-columns ">
                ...
                <div class="content-wrapper">
                    <div class="container-fluid">
                        <section id="dom">
                                    ...
                                    <div class="card">
                                        <div class="card-header">
                                            <div class="card-title-wrap bar-success">
                                                <h4 class="card-title">Jadwal Absensi</h4>
                                            </div>
                                        </div>
                                        <div class="card-body collapse show">
                                            <div class="card-block card-dashboard">
                                                <button type="button" class="btn btn-outline-success btn-block btn-lg" data-toggle="modal" data-target="#tambahwaktu">
                                                    Tambah Waktu Absensi
                                                </button>
                            ...
                            <!-- Tambah -->
                            <div class="modal fade text-left" id="tambahwaktu" tabindex="-1" role="dialog" aria-labelledby="myModalLabel17" aria-hidden="true">
                                        ...
                                        <form data-toggle="validator" method="POST">
                                            <div class="modal-body">
                                                <div class="form-group">
                                                    <label class="control-label" for="id">Waktu Mulai</label>
                                                    <input type="text" name="waktumulai" class="waktumulai form-control" required />
                                                </div>
                                                <div class="form-group">
                                                    <label class="control-label" for="nama">Waktu Selesai</label>
                                                    <input type="text" name="waktuselesai" class="waktuselesai form-control" required />
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="bagian" class="form-control" required>
                                                        <option value="0">Pemasaran</option>
                            ...
                            <!-- Edit -->
                            <div class="modal fade text-left" id="ubahwaktu" tabindex="-1" role="dialog" aria-labelledby="myModalLabel17" aria-hidden="true">
                                <div class="modal-dialog modal-lg" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
    ...
    <script src="<?= $domain;?>assets/js/cyi_waktu.js"></script>
    <script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/twbs-pagination/1.3.1/jquery.twbsPagination.min.js"></script>
    <script src="https://cdn.jsdelivr.net/npm/flatpickr"></script>
    <script>
    $(".waktumulai").flatpickr({
    enableTime: true,
    dateFormat: "Y-m-d H:i",
    });
    $(".waktuselesai").flatpickr({
    enableTime: true,
    dateFormat: "Y-m-d H:i",
    });
    </script>
